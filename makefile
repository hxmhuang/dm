...
tiny:
	make clean
	make main 
	-@${MPIEXEC} -n 1 ./main -m 3 -n 2 -ep 3.1 -debug -ksp_type bcgs -pc_type bjacobi -sub_ksp_type preonly -sub_pc_type sor

small:
	make clean
	make main 
	-@${MPIEXEC} -n 2 ./main -m 3 -n 2 -ep 3.1 -debug -ksp_type bcgs -pc_type bjacobi -sub_ksp_type preonly -sub_pc_type sor
