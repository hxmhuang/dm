...
#include "data_rand.F90"
#include "data_consts.F90"
...
#:else
       a_${d}$d(xs:xe,ys:ye) = &
            alpha(1) + beta(1) * ${op[2]}$(b1_${d}$d(xs:xe,ys:ye))
#:endif
...
#:else
       a_${d}$d(xs:xe,ys:ye,zs:ze) = &
            alpha(1) * beta(1) * ${op[3]}$(b1_${d}$d(xs:xe,ys:ye,zs:ze))
#:endif
